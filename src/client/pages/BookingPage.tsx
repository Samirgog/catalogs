...
export function BookingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col pb-32 bg-background">
      <div className="p-4">
        <div className="flex items-center mb-6">
          <Button variant="ghost" size="icon" onClick={handleBack}>
            <ArrowLeft className="h-5 w-5" />
          </Button>
          <h1 className="text-xl font-semibold ml-2 flex-1">Booking</h1>
        </div>
        ...
        <Card>
          <CardHeader className="pb-0 gap-2">
            ...
            <CardTitle className="mt-3">{selectedItem.title}</CardTitle>
          </CardHeader>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white pt-4 pb-8 px-4 border-t">
