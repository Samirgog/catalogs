...
const staffTutorialSteps: TutorialStep[] = [
  {
    ...
    description:
      'Передайте этот код сотруднику, чтобы он подключился к заказам в Telegram-боте.',
  },
  {
    id: 'bot-link',
    ...
    description:
      'Эту ссылку можно отправить сотрудникам вместе с кодом доступа.',
  },
  {
    id: 'members',
    ...
    description:
      'Здесь можно включать и отключать сотрудников для получения уведомлений.',
  },
];
...
export function StaffPage() {
  ...
  const staffBotUrl =
    import.meta.env.VITE_STAFF_BOT_URL || 'https://t.me/v_click_orders_bot';
          ...
          <CardContent className="space-y-3" data-tour="staff-access-code">
            ...
            <div className="space-y-2" data-tour="staff-bot-link">
              ...
              <div className="flex gap-2">
                <Input readOnly value={staffBotUrl} />
                <Button
                  variant="outline"
                  size="icon"
